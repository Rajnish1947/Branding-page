const Login=()=>{
return<body classNameName="d-flex align-items-center py-4 bg-body-tertiary">
<svg xmlns="http://www.w3.org/2000/svg" classNameName="d-none">
...
<img className="mb-4" src="/image/brand_logo.png"  alt="" width="72" height="57"/>
